...
import Permission from "../src/db/models/PermissionSchema";
import Role from "../src/db/models/RoleSchema";
import { Role as RoleEnum, RolePermissions } from "../src/auth/roles";
import { Permission as PermissionEnum } from "../src/auth/permissions";
import doenv from "dotenv";

/**
 * Migrates the roles and permissions system to the database
 */
